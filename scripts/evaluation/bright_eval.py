...
if __name__=='__main__':
    ...
    parser.add_argument('--model', type=str, required=True,
                        choices=['bm25','cohere','e5','google','grit','inst-l','inst-xl',
                                 'openai','qwen','qwen2','sbert','sf','voyage','bge','bm25_with_reasoner','bge_with_reasoner'])
    ...
    parser.add_argument('--config_dir', type=str, default='scripts/evaluation/configs')
    ...
    if not os.path.isfile(score_file_path):
        ...
        if args.reasoner_file:
            kwargs.update({'reasoner_file': args.reasoner_file})
